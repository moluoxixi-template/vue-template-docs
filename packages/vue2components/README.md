...
这是一个基于 Vue 2 + TypeScript + Vite 的组件库开发模板，支持组件独立打包和类型声明生成。

## 项目特性

- 🚀 **Vue 2 + TypeScript** - 使用 Vue 2.4.x 版本和 TypeScript，支持 Composition API（通过 @vue/composition-api）
- 📦 **组件独立打包** - 每个组件可以独立打包发布
- 🎯 **类型声明生成** - 自动生成完整的 TypeScript 类型声明
- 🎨 **Element UI 集成** - 基于 Element UI 组件库
- 📱 **响应式设计** - 支持移动端和桌面端
- 🔧 **开发工具** - 完整的开发、构建、测试工具链
- ⚡ **Vite 支持** - 使用 vite-plugin-vue2 插件支持 Vue 2
...
2. **编写代码** - 使用 TypeScript 和 Vue 2 Options API 或 Composition API（需要 @vue/composition-api）
...
#### 依赖版本
- Vue 2.4.4 - 符合要求的低于 2.5 版本
- Element UI 2.15.14 - 替代 Element Plus
- Vue Router 3.6.5 - Vue 2 对应版本
- Vuex 3.6.2 - Vue 2 状态管理
- @vue/composition-api 1.7.2 - 支持 Composition API

#### 开发注意事项
1. **组件开发** - 可以使用 Options API 或通过 @vue/composition-api 使用 Composition API
2. **状态管理** - 使用 Vuex 替代 Pinia
3. **路由** - 使用 Vue Router 3.x 语法
4. **Element UI** - 使用 Element UI 替代 Element Plus
5. **构建工具** - 使用 vite-plugin-vue2 插件
