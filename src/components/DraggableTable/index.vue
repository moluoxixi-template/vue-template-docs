...
type ColumnType = VxeTableDefines.ColumnOptions & customColumnProps
defineOptions({
  name: 'DraggableTable',
})
// 定义组件属性
const props = defineProps({
  ...
  editRules: {
    type: Object as () => VxeTablePropTypes.EditRules,
    default: null,
  },
  editConfig: {
  ...
  filterConfig: {
    type: Object as () => VxeTablePropTypes.FilterConfig,
    default: () => ({}),
  },
  //#endregion
  //#region 行列拖拽
